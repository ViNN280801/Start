...
from tabs.graphical_editor.geometry.geometry_constants import GEOMETRY_MESH_RESOLUTION_HINT, GEOMETRY_MESH_RESOLUTION_VALUE
...
class BoxDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.xInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_XMIN,
                                        GEOMETRY_BOX_XMAX,
                                        GEOMETRY_BOX_FIELD_PRECISION))
        self.yInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_YMIN,
                                        GEOMETRY_BOX_YMAX,
                                        GEOMETRY_BOX_FIELD_PRECISION))
        self.zInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_ZMIN,
                                        GEOMETRY_BOX_ZMAX,
                                        GEOMETRY_BOX_FIELD_PRECISION))
        self.lengthInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_LENGTH_MIN,
                                        GEOMETRY_BOX_LENGTH_MAX,
                                        GEOMETRY_BOX_FIELD_PRECISION))
        self.widthInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_WIDTH_MIN,
                                        GEOMETRY_BOX_WIDTH_MAX,
                                        GEOMETRY_BOX_FIELD_PRECISION))
        self.heightInput.setValidator(
            CustomSignedDoubleValidator(GEOMETRY_BOX_HEIGHT_MIN,
