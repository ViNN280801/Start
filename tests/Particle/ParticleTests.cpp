...
TEST(ParticleTest, ConstructorWithTypeAndPositionAndEnergy)
{
    ...
    EXPECT_NEAR(particle.getEnergy_J(), 1.0 / 6.241506363094e+18, 1e10);
}
...
TEST(ParticleTest, ConstructorWithTypeConstPointRefAndEnergy)
{
    ...
    EXPECT_NEAR(particle.getEnergy_J(), 2 / 6.241506363094e+18, 1e10);
}
...
TEST(ParticleTest, ConstructorWithTypeRvaluePointAndEnergy)
{
    ...
    EXPECT_NEAR(particle.getEnergy_J(), 1.4 / 6.241506363094e+18, 1e10);
}
