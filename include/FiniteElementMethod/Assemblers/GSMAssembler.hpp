#ifndef GSM_ASSEMBLER_HPP
#define GSM_ASSEMBLER_HPP
 ...
 *
 * ### Key Features
 * - **Mesh Handling**: Manages and processes tetrahedron meshes using `VolumetricMesh`.
...
private:
    ...
    VolumetricMesh m_meshManager;       ///< Manages the mesh and its properties.
